...
from .views import (
    ...
    FormaPagamentoOrigemDetailAPIView,
    FormaPagamentoOrigemListCreateAPIView,
    FormaPagamentoMapeamentoListAPIView,
    FormaPagamentoMapeamentoLoteAPIView,
    FormaPagamentoMapeamentoOpcoesAPIView,
    ...
    PlanoContaOpcoesAPIView,
    PlanoContaRaizesAPIView,
    PlanoContaViewSet,
...
urlpatterns = [
    ...
    path("plano-contas/raizes", PlanoContaRaizesAPIView.as_view(), name="cadastros-plano-contas-raizes"),
    path("plano-contas/opcoes", PlanoContaOpcoesAPIView.as_view(), name="cadastros-plano-contas-opcoes"),
    ...
    path("formas-pagamento/origens", FormaPagamentoOrigemListCreateAPIView.as_view(), name="cadastros-formas-pagamento-origens"),
    path("formas-pagamento/origens/<int:id_origem>", FormaPagamentoOrigemDetailAPIView.as_view(), name="cadastros-formas-pagamento-origens-detail"),
    path("formas-pagamento/mapeamentos", FormaPagamentoMapeamentoListAPIView.as_view(), name="cadastros-formas-pagamento-mapeamentos"),
    path("formas-pagamento/mapeamentos/opcoes", FormaPagamentoMapeamentoOpcoesAPIView.as_view(), name="cadastros-formas-pagamento-mapeamentos-opcoes"),
    path("formas-pagamento/<int:id_forma>/mapeamentos", FormaPagamentoMapeamentoLoteAPIView.as_view(), name="cadastros-formas-pagamento-mapeamentos-lote"),
